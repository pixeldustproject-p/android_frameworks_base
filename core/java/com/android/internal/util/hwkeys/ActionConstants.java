...
public class ActionConstants {
    ...
    public static final int SMARTBAR = 2;
...
*/
    ...
    public static class Fling implements Defaults {
        ...
        public static final String FLING_CONFIG_DEFAULT =
              ...
              + dl(SystemAction.GoogleAssistant.mAction)    + dl(SystemAction.GoogleAssistant.mLabelRes)   + dl(EMPTY)  // long fling
