...
package com.android.internal.util.pixeldust.ambient.play;
...
public class AmbientPlayHistoryManager {
    ...
    private static String ACTION_SONG_MATCH = "com.android.internal.util.pixeldust.ambient.play.AMBIENT_PLAY_SONG_MATCH";
    public static Intent INTENT_SONG_MATCH = new Intent(ACTION_SONG_MATCH);
    public static final String SERVICE_PACKAGE = "com.pixeldust.ambient.play.history";
